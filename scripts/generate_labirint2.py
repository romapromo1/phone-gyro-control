...
CORNER_RADIUS = 1.4         # Large radius for smooth corners
...
def main():
    print("\n" + "=" * 60)
    print("GENERATING NEW LABYRINTH 2 WITH CURVED INNER WALLS")
    print("=" * 60)
    ...
    # Planar Decimate to clean up straight segments
